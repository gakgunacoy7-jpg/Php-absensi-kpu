...
<head>
    <meta charset="UTF-8">
    <title>Data Kegiatan Bulan Ini</title>
...
<nav class="navbar bg-dark border-bottom border-body" data-bs-theme="dark">
  <div class="container-fluid">
    ...
    <ul class="nav nav-underline">
      <li class="nav-item">
        <a class="nav-link" href="admin.php">Riwayat</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="admink.php">Data Kegiatan</a>
      </li>
...
<div class="container mt-5">
    <h2 class="h2">Data Kegiatan Bulan Ini</h2>
<br>
    ...
    <table>
        ...
        $sqlh = "SELECT * FROM absensi WHERE keterangan='hadir'";
