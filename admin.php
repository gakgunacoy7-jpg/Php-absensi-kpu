...
<head>
    <meta charset="UTF-8">
    <title>Riwayat Absensi Hari Ini</title>
...
<div class="container mt-5">
    <h2 class="h2">Riwayat Absensi Hari Ini</h2><br>
...
<br>
  <div class="btn-group">
  <a href="admin.php" class="btn btn-primary active" aria-current="page"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar2-day-fill" viewBox="0 0 16 16">
